...
path_train = "/content/joint-vae/data/HandwrittenArabic" \
...
torch.save(model.state_dict(), '/content/joint-vae/trained_models/arabic/model.pt')
...
with open('/content/joint-vae/trained_models/arabic/specs.json', 'w') as file:
