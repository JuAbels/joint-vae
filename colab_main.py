...
# TODO Loss
chart_viewer(save_dir, "Loss Visualization (%s , Adam, %s)" % (dataset[0].upper() + dataset[1:]
             ,loss), "Epochs", "Loss", xdata, ydata)
